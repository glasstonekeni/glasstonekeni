...
- 💻 Strong foundation in **Java** and object-oriented design, with hands-on experience across the backend and full stack
...
- 🌱 Currently sharpening skills in Spring Boot, system design, and database optimization
...
`Java` `Spring Boot` `Hibernate` `MySQL` `REST APIs` `Multithreading`
A multi-module Java application managing book inventory, member accounts, and reservations across multiple library branches. Features a layered Spring Boot + Hibernate backend, REST APIs for catalog search and fine calculation, and thread-safe concurrent reservation handling with synchronized inventory locks.
...
- **Web Development Intern** — EdVedha Edutech Pvt. Ltd. *(Mar 2025 – May 2025)*
  Built a full-stack Task Management Application covering task creation, tracking, and deadline management.
